...
public class Instruction implements de.turing85.yane.api.Instruction {
  ...
  static {
    INSTRUCTIONS = Set.of(
        ...
        Instruction.of(Command.ASL, AddressingMode.IMPLIED, (byte) 0x0A, 1, 2),
        ...
        Instruction.of(Command.ROL, AddressingMode.IMPLIED, (byte) 0x2A, 1, 2),
        ...
        Instruction.of(Command.LSR, AddressingMode.IMPLIED, (byte) 0x4A, 1, 2),
        ...
        Instruction.of(Command.ROR, AddressingMode.IMPLIED, (byte) 0x6A, 1, 2),
